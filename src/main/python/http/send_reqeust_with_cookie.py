...
headers = {
    ...
    "Cookie":"ddc_ticket=d110571c686cc1f80489bc4ab37a0abc000280000;username=jefffang",
    "Host":"bigdata.xiaojukeji.com"
}

bigdata_response = session.get('http://bigdata.xiaojukeji.com/dcp/fw/user/preference/v2/get')
...
r = requests.post('http://bigdata.xiaojukeji.com/report/v2/monitor/config/save',timeout=10,json=json_str,headers=headers)
